...
const SubscriptionCard = ({ name, price, currency, icon, billing, color, category, plan, paymentMethod, startDate, renewalDate, status, expanded, onPress }: SubscriptionCardProps ) => {
  return (
